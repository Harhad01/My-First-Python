...
# Day 4 Project: Mastering conditional logic (if/elif/else) and nested statements
...
# First decision point with .lower() for case-insensitive input
choice1 = input("You're at a crossroad. Where do you want to go? Type 'left' or 'right': ").lower()

# Nested if/else statements creating multiple game paths
if choice1 == "left":
